...
@Component({
  ...
  template: `
    <div class="app-container" [class.sidebar-collapsed]="isCollapsed()">
      ...
      <aside class="sidebar">
        <div class="brand">
          <img src="logo.png" alt="Logo" class="logo-img" width="200" height="50" />
        </div>
        ...
        <nav class="nav-menu">
          ...
          >
            ...
            <span class="nav-label">{{
              user()?.role === 'super_admin' ? 'Administrateurs' : 'Agents'
            }}</span>
          </a>
          <a
            *ngIf="user()?.role === 'admin' || user()?.role === 'agent'"
          ...
          >
            ...
            <span class="nav-label">Processus</span>
          </a>
          <a
            *ngIf="user()?.role === 'admin'"
            routerLink="/roles"
          ...
          >
            ...
            <span class="nav-label">Audit & Sécurité</span>
          </a>
          <a
            *ngIf="user()?.role === 'admin' || user()?.role === 'super_admin'"
            routerLink="/ia"
          ...
          <div class="actions">
            <div class="notifications-dropdown">
              <button class="icon-btn" (click)="toggleNotifs()">
                ...
                <span class="badge" *ngIf="notifService.nonLues() > 0">{{
