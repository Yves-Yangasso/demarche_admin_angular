    ...
    <app-layout>
      <div class="header">
        <div>
          ...
          <p class="subtitle">
            Définissez les étapes de validation hiérarchique pour chaque type de dossier.
          </p>
        </div>
          ...
          <div class="steps-list">
            <div class="step-item" *ngFor="let step of wf.steps; let i = index">
              ...
              <div class="step-info">
                ...
                <div class="step-role">
                  Rôle requis : <strong>{{ step.role_organisation_nom }}</strong>
                </div>
              </div>
...
export class WorkflowListComponent implements OnInit {
  ...
  saveStep() {
    this.http
      .post(`/api/workflows/${this.stepForm.workflow_id}/steps`, this.stepForm)
      .subscribe(() => {
