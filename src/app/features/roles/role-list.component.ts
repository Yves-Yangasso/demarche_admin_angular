    ...
    <app-layout>
      <div class="header">
        <div>
          ...
          <p class="subtitle">
            Gérez les rôles personnalisés de votre organisation et définissez leurs habilitations.
          </p>
        </div>
      ...
      <div class="roles-grid">
        <div class="card role-card" *ngFor="let role of roles()">
          <div class="role-header">
            <h3>{{ role.nom }}</h3>
            <span class="status-pill" [class.active]="role.actif">{{
              role.actif ? 'Actif' : 'Désactivé'
            }}</span>
          </div>
            ...
            <div class="privileges-selector">
              ...
              <div class="priv-grid">
                <label class="priv-item" *ngFor="let p of catalog()">
                  <input
                    type="checkbox"
                    [checked]="hasPrivilege(p.code)"
                    (change)="togglePrivilege(p.code)"
                  />
                  <div class="priv-info">
...
export class RoleListComponent implements OnInit {
  ...
  hasPrivilege(code: string) {
    return this.form.privileges.includes(code);
  }
